...
#define KRT_SENS_AZIMUTH    512    // азимут
#define KRT_SENS_TANGAZH   1024    // тангаж
#define KRT_SENS_UGOL3D    KRT_SENS_AZIMUTH & KRT_SENS_TANGAZH // азимут + тангаж
...
// эти типы датчиков можно интерпретировать, как отсутствие данных о типе датчиков
...
#define SENS_TYPE_RESIDUAL    4    // Остаточная намагниченность
#define SENS_TYPE_PROFIL      5    // Профильные датчики
#define SENS_TYPE_TFI         6    // продольная намагниченность (стресс)
#define SENS_TYPE_MFL         7    // поперечная намагниченность (коррозионник)
#define SENS_TYPE_INTROSCOPE  8    // интроскоп
